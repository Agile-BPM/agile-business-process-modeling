...
export default class CustomRenderer extends BaseRenderer {
  ...
  constructor(eventBus: any, bpmnRenderer: any, customElementsService: any) {
  ...
  drawUserStory(parentNode: SVGElement, element: any, customElement: any): SVGElement {
    ...
    rect.setAttribute("stroke", "rgb(90, 142, 46)")
    ...
    headerBar.setAttribute("fill", "rgb(90, 142, 46)")
    ...
    bookmarkIcon.setAttribute("stroke", "rgba(255, 255, 255, 0.3)")
    ...
    storyIdText.setAttribute("fill", "white")
  ...
  drawSubtask(parentNode: SVGElement, element: any, customElement: any): SVGElement {
    ...
    headerBar.setAttribute("fill", "#0052CC")
    ...
    subtaskIcon.setAttribute("fill", "white")
    subtaskIcon.setAttribute("transform", "scale(0.025, 0.025)")
    subtaskIcon.setAttribute("stroke", "rgba(255, 255, 255, 0.3)")
    ...
    subtaskIdText.setAttribute("fill", "white")
  ...
  createStatusBadge(status: string, statusCategory: string, x: number, y: number, id: string): SVGElement {
    ...
    const statusColors = this.getStatusColors(statusCategory)
  ...
  createPriorityBadge(priority: string, x: number, y: number, id: string): SVGElement {
    ...
    const priorityColors = this.getPriorityColors(priority)
  ...
  createProgressBar(progress: number, x: number, y: number, width: number, id: string): SVGElement {
    ...
    backgroundBar.setAttribute("fill", "#e0e0e0")
  ...
  drawEpic(parentNode: SVGElement, element: any, customElement: any): SVGElement {
    ...
    feDropShadow.setAttribute("flood-color", "rgba(103, 58, 183, 0.3)")
    filter.appendChild(feDropShadow)
    ...
    headerBar.setAttribute("fill", "#673AB7")
    ...
    epicIcon.setAttribute("fill", "white")
    epicIcon.setAttribute("transform", "scale(0.03, 0.03)")
    epicIcon.setAttribute("stroke", "rgba(255, 255, 255, 0.3)")
    ...
    epicIdText.setAttribute("fill", "white")
